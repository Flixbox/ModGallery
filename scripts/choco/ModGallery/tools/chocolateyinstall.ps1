...
$url        = 'https://github.com/Flixbox/ModGallery/releases/download/v22.289.1300/modgallery-Setup-22.289.1300.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'ModGallery*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
